...
<div class="flex w-screen h-screen overflow-hidden">
    <aside class="w-64 h-full bg-white shadow-lg overflow-y-auto">
        <?php echo $__env->make('posts.leftside', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </aside>

    <div class="flex-1 h-full flex flex-col">
        <a href="<?php echo e(route('posts.create')); ?>" class="w-full bg-gray-100 px-6 py-4 shadow-md block">
            ...
            <div class="w-full max-w-5xl bg-white rounded-3xl my-6 shadow-2xl transition-shadow duration-300">
                <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="my-8 last:my-0 bg-gray-50 rounded-xl shadow-md p-4"> <!-- Card container with margin, background, and shadow -->
                        <div class="flex items-center justify-between p-8 border-b">
                            <div class="gap-6 flex items-center">
                                ...
                                <div class="flex flex-col">
                                    <b class="mb-2 text-2xl capitalize text-gray-900 font-bold tracking-tight"><?php echo e($post->user->name); ?></b>
                                    <time datetime="<?php echo e($post->created_at ? $post->created_at->format('d-m-y') : ''); ?>" class="text-gray-500 text-lg">
                                        <?php echo e($post->created_at ? $post->created_at->toFormattedDateString() : 'No date available'); ?>
                            ...
                            <div x-data="{ open: false }" class="relative">
                                <?php if(auth()->id() == $post->user_id): ?>
                                    ...
                                    <div x-show="open" @click.outside="open = false" class="dropdown-menu absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg z-10 overflow-hidden">
                                        <form action="<?php echo e(route('posts.destroy', $post->id)); ?>" method="POST" class="p-2">
                                            <?php echo csrf_field(); ?>
                        ...
                        <h3 class="font-bold text-4xl text-gray-900 p-8"><?php echo e($post->title); ?></h3>
                        <?php if($post->content && $post->content->data): ?>
                            <div class="flex justify-center p-8 border-b">
                                <img src="<?php echo e(asset('storage/' . $post->content->data)); ?>" class="rounded-3xl w-full h-[calc(100vh-20rem)] object-cover transition-transform duration-300 hover:scale-[1.02] shadow-lg" alt="Post image">
                            </div>
                        <?php endif; ?>
                    </div>
                    <?php if (! ($loop->last)): ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="p-8 text-center text-gray-500 text-xl bg-gray-50 rounded-xl">
                        No posts available. <a href="<?php echo e(route('posts.create')); ?>" class="text-indigo-600 hover:underline">Create one now!</a>
                    </div>
                <?php endif; ?>
...
<?php /**PATH C:\Users\Enkel\Desktop\webapp-upBizz\resources\views/posts/index.blade.php ENDPATH**/ ?>