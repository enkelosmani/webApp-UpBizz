    ...
    <main class="flex-1 flex flex-col items-center p-4 sm:p-6 md:p-8 overflow-y-auto">
        <div class="relative flex flex-col items-center rounded-[30px] w-full max-w-[1200px] mx-auto p-6 sm:p-8 md:p-10 bg-white bg-clip-border shadow-2xl profile-card dark:!bg-navy-800 dark:text-white">
            ...
            <div class="mt-20 sm:mt-24 md:mt-28 flex flex-col items-center">
                <h4 class="text-3xl sm:text-4xl font-bold text-navy-700 dark:text-black"><?php echo e($user->name); ?></h4>
            </div>
            <!-- Stats -->
            <div class="mt-8 mb-6 sm:mt-10 sm:mb-8 flex gap-12 sm:gap-20">
                <div class="flex flex-col items-center justify-center">
                    <p class="text-3xl sm:text-4xl font-bold text-navy-700 dark:text-black"><?php echo e($user->posts->count()); ?></p>
            ...
            <div class="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $user->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if($post->content && $post->content->data): ?>
                        <div class="relative">
                            <img src="<?php echo e(asset('storage/' . $post->content->data)); ?>" alt="Post Image" class="w-full h-auto object-cover rounded-xl post-image">
                            <form action="<?php echo e(route('posts.destroy', $post->id)); ?>" method="POST" class="absolute top-2 right-2 sm:top-3 sm:right-3">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Enkel\Desktop\webapp-upBizz\resources\views/users/index.blade.php ENDPATH**/ ?>